package com.halburt.hsite.jwtDemo2;
	...
	public boolean valid(String token) throws InvalidJwtException{
		...
		*/
		JwtConsumer jwtConsumer = new JwtConsumerBuilder()
				...
				.setRequireSubject()
				.setRequireNotBefore()
				.setExpectedSubject("req.getRemoteAddr()")
				.setVerificationKey(TokenUtils.getRsaJsonWebKey().getKey()) // verify the signature with the public key
